...
# Create SparkSession
spark = SparkSession.builder.appName("Query 1 with Dataframes API & .parquet files").getOrCreate()
sc = spark.sparkContext.setLogLevel("WARN")
sc = spark.sparkContext.setLogLevel("ERROR")
start_time = time.time()

# Define HDFS paths for the parquet files and read as Dataframes
HDFS_path_for_2010_2019 = "hdfs://master:9000/bigdata/Crime_Data_from_2010_to_2019.parquet"
HDFS_path_for_2020_today = "hdfs://master:9000/bigdata/Crime_Data_from_2020_to_Present.parquet"
crime_df_2010_2019 = spark.read.parquet(HDFS_path_for_2010_2019, header=True, inferSchema=True)
crime_df_2020_today = spark.read.parquet(HDFS_path_for_2020_today, header=True, inferSchema=True)
