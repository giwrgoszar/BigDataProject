...
spark = SparkSession.builder.appName("Query 3 with MERGE join").getOrCreate()
...
crime_with_zip_df = crime_df_2010_2019.join(revgeocoding_df.hint("MERGE"), (crime_df_2010_2019["LAT"] == revgeocoding_df["LAT"]) \
...
#(e.g. $55,362 --> 55326)
crime_with_zip_income_df = crime_with_zip_df.join(income_df.hint("MERGE"), crime_with_zip_df["ZIPcode"] == income_df["Zip Code"], "inner") \
...
print("Answer for Query 3 with MERGE join:\n")
